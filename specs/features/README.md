...
| `ui-widget-table.feature` | Keyboard-navigable table widget (row/column selection, wrap-around, row-level confirm) — no real consumer yet, proven in isolation |
| `ui-widget-radio-group.feature` | Single-select radio group widget (vertical Up/Down layout, wrap-around) — no real consumer yet, proven in isolation |
